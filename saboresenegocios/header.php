...
<head>
  ...
  <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-MTNVYE67P2"></script>
  <script>
...
<body <?php body_class(); ?>>  
  ...
  <header>
    <div class="container">
      <div class="content">
        <h1><a href="<?php echo site_url(); ?>">Sabores e Negócios</a></h1>
        <?php wp_nav_menu(array('theme_location' => 'main-menu')); ?>
        <?php get_search_form(); ?>
        <ul class="social">
